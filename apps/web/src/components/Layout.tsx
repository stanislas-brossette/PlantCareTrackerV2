...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-green-50 dark:bg-gray-900 flex flex-col">
      <header
        className="bg-green-700 text-white px-4 pb-3 flex items-center justify-between shadow-md"
      ...
      <div className="relative h-1 overflow-hidden bg-green-900/15 dark:bg-black/20">
        <div
          className={`absolute inset-y-0 left-0 rounded-r-full bg-gradient-to-r from-lime-300 via-emerald-200 to-green-100 dark:from-lime-400 dark:via-emerald-300 dark:to-green-200 ${isSyncing ? "sync-bar-active" : ""}`}
          style={{
      ...
      >
        ...
        >
          <div className="min-w-[208px] rounded-[22px] border border-white/60 bg-white/95 px-3 py-2.5 text-xs text-gray-700 shadow-lg shadow-green-900/10 backdrop-blur dark:border-gray-700 dark:bg-gray-800/95 dark:text-gray-200">
            <div className="flex items-center gap-3">
              <div className="relative flex h-9 w-9 items-center justify-center">
                <div
                  className="absolute inset-0 rounded-full bg-gradient-to-br from-green-200 via-lime-100 to-emerald-50 dark:from-green-900/60 dark:via-green-800/50 dark:to-gray-800"
                ...
                <svg className="absolute inset-0 -rotate-90" viewBox="0 0 36 36">
                  ...
                  <circle
                    ...
                    className="text-green-600 transition-all duration-150 dark:text-green-300"
                  />
                </svg>
                <RefreshCw
                  className={`relative h-4 w-4 text-green-700 dark:text-green-200 ${isSyncing ? "animate-spin" : ""}`}
        ...
        >
          <div
            className="h-full w-full rounded-full bg-gradient-to-r from-green-300/40 via-lime-200/35 to-emerald-300/40 blur-xl dark:from-green-500/20 dark:via-lime-400/10 dark:to-emerald-400/20"
